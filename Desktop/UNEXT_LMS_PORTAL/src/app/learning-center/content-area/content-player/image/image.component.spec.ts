...
describe('ImageComponent', () => {
  ...
  it('should call zoom function with positive', () => {
    ...
    expect(component.imageHolder.nativeElement.style.width).toEqual('65vw');
    component.zoom('negative');
    expect(component.imageHolder.nativeElement.style.width).toEqual('55vw');
  });
  ...
  it('should call rotate function', () => {
    component.rotate(); expect(component.imageHolder.nativeElement.style.transform).toBe('rotate(90deg)');
    component.rotateAngle = 90;
    expect(component.imageHolder.nativeElement.style.height).toBe('55vw');
  });
